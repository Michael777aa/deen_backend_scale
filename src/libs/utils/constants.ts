...
export const WEB_REDIRECT_URI = `${process.env.EXPO_PUBLIC_BASE_URL}/api/v1/auth/callback`;
export const MOBILE_REDIRECT_URI = `${process.env.EXPO_PUBLIC_SCHEME}oauth`;
